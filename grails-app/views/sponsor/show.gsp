            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="sponsor.description.label" default="Description" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="sponsor.sponsorships.label" default="Sponsorships" /></td>
