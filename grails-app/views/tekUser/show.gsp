            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="tekUser.id.label" default="Id" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="tekUser.fullName.label" default="Full Name" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="tekUser.userName.label" default="User Name" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="tekUser.email.label" default="Email" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="tekUser.website.label" default="Website" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="tekUser.bio.label" default="Bio" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="tekUser.password.label" default="Password" /></td>
